...
class MultipleChoice extends React.Component {
  ...
  render() {
    ...
    // all props passed in from invoked component attributes
    const { id, question, a1, a2, a3, a4, handler, correct  } = this.props;
      ...
      <div id={id} className="question-block">
        ...
        <form
          onSubmit={e=>{
            e.preventDefault()
            this.handleCorrect()
            selected == correct ? handler() : this.handleIncorrect()
          }}
        >
